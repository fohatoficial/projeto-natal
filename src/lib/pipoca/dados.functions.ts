...
// capital mais recente em que apareceram, e timestamp da última atividade.
// Volume previsto baixo (~milhares no máximo). Sem `.in()` de tamanho
// proporcional ao conjunto: usamos embeds do PostgREST.
